...
2. Go to Shipping zones
3. Add shipping method to shipping zone
4. Select "Distance Based Shipping" from dropdown
5. Edit newly added method
6. Change method title/label and add other values
